...
export const SCHOOLS: School[] = [
  {
    ...
    checklist: [
      ...
      { id: 'rapor', l: 'Foto rapor sem 1\u20134 yang sudah dilegalisir', d: '20 Sep 2026', dl: '2026-09-20', note: 'Nilai pengetahuan B.Indo, B.Ing, Matematika, IPA', up: true },
      { id: 'surat', l: 'Surat pernyataan kepsek, ortu, dan casis', d: '21 Sep 2026', dl: '2026-09-21', note: 'Format resmi: bit.ly/PersyaratanPensisruSMATN', up: true },
      { id: 'sehat', l: 'Surat keterangan sehat dari dokter', d: '21 Sep 2026', dl: '2026-09-21', up: true },
      { id: 'iq', l: 'Opsional: tes IQ \u2265 110 (HIMPSI) & TOEFL sebagai nilai tambah', d: '21 Sep 2026', dl: '2026-09-21', up: true },
      { id: 'prestasi', l: 'Scan sertifikat prestasi (wajib untuk jalur prestasi)', d: '21 Sep 2026', dl: '2026-09-21', up: true },
  ...
  },
  {
    ...
    checklist: [
      ...
      { id: 'rapor', l: 'Siapkan scan rapor \u2014 isi jujur, data fiktif = diskualifikasi', d: 'Nov 2026', dl: '2026-11-20', up: true },
  ...
  },
  {
    ...
    checklist: [
      { id: 'iq', l: 'Tes IQ di biro psikologi anggota HIMPSI (target \u2265 115)', d: 'Nov 2026', dl: '2026-11-30', note: 'Sertifikat berlaku 6 bulan \u2014 jangan tes terlalu awal', up: true },
      ...
      { id: 'rapor', l: 'Legalisir rapor semester 1\u20135', d: 'Jan 2027', dl: '2027-01-10', up: true },
  ...
  },
  {
    ...
    checklist: [
      { id: 'kk', l: 'Pastikan KK DKI Jakarta atas nama anak terbit ≥ 1 tahun sebelum pendaftaran', d: 'Cek sekarang', dl: '2026-12-31', note: 'Dokumen · 2026/27: KK terbit paling lambat 1 Feb 2025', up: true },
      { id: 'rapor', l: 'Legalisir rapor kelas 7 (sem 1–2), 8 (sem 1–2), 9 (sem 1) — minta konversi predikat huruf → angka ke sekolah asal', d: 'Jan 2027', dl: '2027-01-31', note: 'Dokumen · rata-rata Mat/IPA/B.Inggris masing-masing ≥ 90', up: true },
      { id: 'rekom', l: 'Surat rekomendasi Kepala Sekolah asal (format diunduh di laman SPMB, dikirim kolektif)', d: 'Jan 2027', dl: '2027-01-31', note: 'Dokumen · wajib semua jalur', up: true },
      { id: 'berkas', l: 'Siapkan akta kelahiran, NISN, dan pas foto', d: 'Jan 2027', dl: '2027-01-31', note: 'Dokumen', f: [{ k: 'nisn', p: 'NISN (10 digit)' }], up: true },
      ...
      { id: 'prestasi', l: 'Jalur Prestasi: sertifikat ASLI medali OSN/OPSI/ITMO/IJSO', d: 'Feb 2027', dl: '2027-02-02', note: 'Dokumen · kuota ±8 murid', up: true },
      { id: 'afirmasi', l: 'Jalur Afirmasi: KJP Plus aktif tahap II / PIP + terdaftar DTKS', d: 'Feb 2027', dl: '2027-02-02', note: 'Dokumen · kuota ±44 murid', up: true },
  ...
  },
  {
    ...
    checklist: [
      ...
      { id: 'rapor', l: 'Legalisir rapor kelas 7\u20139', d: 'Jan 2027', dl: '2027-01-05', up: true },
